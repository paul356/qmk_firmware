...
[_FL] = KEYMAP(
  _______,          TO(_BL), _______, TO(_ML), _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
  _______, USER_M1, USER_M2, USER_M3, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                              \
  _______,          _______, _______, USER_M2, _______, _______, _______, _______, _______, _______, _______,          _______,            _______,          \
...
[_ML] = KEYMAP(
  ...
  _______, _______, _______,                            KC_BTN1,                            _______, MO(_FL), _______, _______,   KC_MS_L, KC_MS_D, KC_MS_R),
};
